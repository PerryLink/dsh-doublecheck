...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2`. Verified 2026-09-22 (dual typecheck rulers + full test suite green); the peer range admits `0.1.2-rc.1`, `0.1.5-alpha.1`, `0.1.5-rc.2`, `0.1.6-alpha.2` and `0.1.7-alpha.1`, so no supported host line is dropped. |
| Node | `^22.19.0 \|\| >=24.0.0` |
