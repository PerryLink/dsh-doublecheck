...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2`. Verificado em 2026-09-22 (typecheck duplo + suíte completa verde); o intervalo de peers admite `0.1.2-rc.1`, `0.1.5-alpha.1`, `0.1.5-rc.2`, `0.1.6-alpha.2` e `0.1.7-alpha.1`, então nenhuma linha suportada é perdida. |
| Node | `^22.19.0 \|\| >=24.0.0` |
