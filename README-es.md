...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2`. Verificado el 2026-09-22 (doble typecheck + suite completa en verde); el rango de peers admite `0.1.2-rc.1`, `0.1.5-alpha.1`, `0.1.5-rc.2`, `0.1.6-alpha.2` y `0.1.7-alpha.1`, así que no se pierde ninguna línea soportada. |
| Node | `^22.19.0 \|\| >=24.0.0` |
