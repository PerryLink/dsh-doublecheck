...
declare module '@deepseek-ai/dsh-llm' {
  interface MessageSourceMap {
     ...
     */
    'dsh-doublecheck': { kind: 'dsh-doublecheck' } & ContextFormed
    /**
 ...
 */
export function noticeSource(summary: NoticeSummary): { kind: 'dsh-doublecheck'; form: 'notice'; summary: string } {
 ...
 */
export function noticeSummaryOf(source: NoticeSourceShape): string | undefined {
  if (source.form !== 'notice' || typeof source.summary !== 'string') return undefined
  if (source.kind === 'dsh-doublecheck' || source.kind === 'plugin:dsh-doublecheck') return source.summary
  if (source.kind === 'plugin' && source.plugin === 'dsh-doublecheck') return source.summary
  return undefined
}
