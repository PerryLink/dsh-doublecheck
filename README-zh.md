...
| 方面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-rc.2`。已于 2026-09-24 核验（双 typecheck 尺子 + 全量测试绿）；peer 区间接纳 `0.1.2-rc.1`、`0.1.5-alpha.1`、`0.1.5-rc.2`、`0.1.6-alpha.2`、`0.1.7-alpha.1` 与 `0.1.7-rc.2`，不丢任何已支持宿主线。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
