...
- 🔁 **टिकाऊ स्थिति** — मॉडल को दिखने वाली हर चीज़ (spec, अनुस्मारक, अस्वीकृति-फ़ीडबैक) सेशन लॉग में दर्ज होती है; द्वारों के निर्णय केवल लॉग से निकलते हैं (`tool/call` + `tool/result`, Code Mode उप-प्रेषण सहित), इसलिए पुनः आरंभ या फ़ॉर्क की गई सेशन भी वैसा ही व्यवहार करती हैं।
...
- id: doublecheck-guard
  config:
    ...
    modules:
      ...
      adversary: false  # v0.3 हेतु आरक्षित — false ही रहे
    adversaryModel: null
...
| `adversaryModel` | `null` | v0.3 आलोचक हेतु आरक्षित; `null` = मुख्य मॉडल स्वयं समीक्षा करता है। गैर-null मान लोड पर विफल होता है। |
