...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.1`। 2026-09-22 को सत्यापित (दोहरा typecheck + पूरी टेस्ट सूट हरी); peer रेंज `0.1.2-rc.1`, `0.1.5-alpha.1`, `0.1.5-rc.2`, `0.1.6-alpha.2` और `0.1.7-alpha.1` को स्वीकार करती है, इसलिए कोई समर्थित लाइन नहीं छूटती। |
| Node | `^22.19.0 \|\| >=24.0.0` |
