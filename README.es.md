...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-rc.1`. Verificado el 2026-09-10 contra el checkout master `dsh-v0.1.5-rc.1` (cadena completa de puertas + humo de instalación del perfil); la línea publicada `0.1.2-rc.1` sigue soportada. |
| Node | `^22.19.0 \|\| >=24.0.0` |
