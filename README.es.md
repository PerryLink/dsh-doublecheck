...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `0.1.2-rc.1`. Verificado el 2026-09-06 contra el checkout master `dsh-v0.1.3-alpha.1` (cadena completa de puertas + humo de instalación del perfil). |
| Node | `^22.19.0 \|\| >=24.0.0` |
